...
import { DeepMutable } from "@com.mgmtp.a12.print/print-model-api/lib/utils/type-utils.js";
import {
...
import { AffectedItem, InteractionLogEntry } from "./interaction-log.js";
 ...
 */
export interface TransactionLogStoreEntry<T extends TransactionLogObject = TransactionLogObject>
...
export interface SegmentsStoreEntryMapWithId<T extends TransactionLogObject = TransactionLogObject>
