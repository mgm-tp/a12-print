...
export class ExpressionDeserializer extends Deserializer<GeneratedDTO.ExpressionDTO, ModelAPI.ExpressionProperties> {
	prefix = "expression";

	map(property: keyof GeneratedDTO.ExpressionDTO, dto: GeneratedDTO.ExpressionDTO) {
		switch (property) {
			case "id":
