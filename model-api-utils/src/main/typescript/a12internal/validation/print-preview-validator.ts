...
import type { CollectedPath } from "../../internal/types/reference-path.js";
import { PartialPrintModelVisitorReferenceCollector } from "../../internal/validation/reference-path-validation/partial-print-model-visitor-reference-collector.js";
...
export namespace PrintPreviewValidator {
	...
	export function validate(printModel: Model, document?: object): PrintPreviewValidationResult {
		...
		const deserializedResult = printModelMarshaller.deserialize(JSON.stringify(printModel), { html: false });
