...
export abstract class ConstantTypeExt {
	static constantTypeFrom(computationFieldType: ComputationFieldType): Constant.ConstantType {
		switch (computationFieldType) {
			...
			case ComputationFieldType.Boolean:
				return Constant.ConstantType.Boolean;
			default:
