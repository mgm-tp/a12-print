...
public class Arithmetic implements SyntaxTreeElement, ArithmeticBranch, CompareBranch, Predicate.Parameter {

	@NonNull
	private final Operator operator;
	@NonNull
	private final ArithmeticBranch[] branches;

	@Override
	public SyntaxTreeElementType elementType() {
		return SyntaxTreeElementType.ARITHMETIC;
	}
