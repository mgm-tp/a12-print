...
public class ComputationParsingException extends PrintCompilerException {
	...
	public ComputationParsingException(String message) {
		super(message);
	}

	public ComputationParsingException(String message, Object... args) {
		super(message, args);
	}

	public ComputationParsingException(String message, Throwable throwable) {
