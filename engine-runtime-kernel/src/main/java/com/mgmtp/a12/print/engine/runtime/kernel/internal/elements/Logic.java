...
public class Logic implements SyntaxTreeElement, LogicBranch {
	@NonNull
	private final Operator operator;
	@NonNull
	private final LogicBranch[] branches;

	public Logic(@NonNull Operator operator, @NonNull LogicBranch[] branches) {
