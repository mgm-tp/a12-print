...
public class LogicBranchShortCircuitNormalisation implements EggRewriteRuleFactory {
				...
				.logic(
					(o, clone) -> {
						for (var branch : clone.getBranches()) {
							if (branch.equals(Constant.TRUE) && clone.getOperator().equals(Logic.Operator.OR)) {
								return b -> Constant.TRUE;
							} else if (branch.equals(Constant.FALSE) && clone.getOperator().equals(Logic.Operator.AND)) {
