 ...
 */
package com.mgmtp.a12.print.model.document.internal.segment;
...
import com.mgmtp.a12.print.model.document.internal.base.PrintElementContainer;
...
public class PrintSegment extends PrintElementContainer {
	...
	public PrintSegment(
		...
		@NonNull List<PrintSection> headerSections,
		@NonNull List<PrintSection> footerSections,
		@NonNull PageOrientation pageOrientation,
		PrintWatermark watermark
	) {
		super(id, elements);
