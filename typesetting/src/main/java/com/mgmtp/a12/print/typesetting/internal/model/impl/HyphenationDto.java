...
@AllArgsConstructor
public class HyphenationDto implements Hyphenation {

	@JsonProperty(value = "general")
	@JsonDeserialize(as = HyphenationGeneralDto.class)
	HyphenationGeneral general;

	@JsonProperty(value = "patterns")
	@JsonDeserialize(contentAs = HyphenationPatternDto.class)
	List<HyphenationPattern> patterns;

	@JsonProperty(value = "exclusions")
	@JsonDeserialize(contentAs = HyphenationExclusionDto.class)
	@Builder.Default
	List<HyphenationExclusion> exclusions = new ArrayList<>();
}
