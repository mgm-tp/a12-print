...
@AllArgsConstructor
public class InternalDto implements Internal {

	@JsonProperty(value = "hyphenation")
	@JsonDeserialize(as = HyphenationDto.class)
	Hyphenation hyphenation;

	@Override
	public Optional<Hyphenation> getHyphenation() {
		return Optional.ofNullable(hyphenation);
	}
}
