...
@AllArgsConstructor
public class TypesettingModelDto implements TypesettingModel {

	@JsonProperty(value = "header", required = true)
	@JsonDeserialize(as = TypesettingHeaderDto.class)
	Header header;

	@JsonProperty(value = "content", required = true)
	@JsonDeserialize(as = TypesettingModelContentDto.class)
	TypesettingModelContent content;
}
