...
public class HyphenMinsDto implements HyphenMins {

	@JsonProperty(value = "typesetting")
	@JsonDeserialize(as = TypeSettingDto.class)
	TypeSetting typeSetting;

	@JsonProperty(value = "generation")
	@JsonDeserialize(as = GenerationDto.class)
