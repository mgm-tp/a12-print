...
@Getter
public class CharTrieMapNode implements CharTrieNode{

    private final CharTrie trie;
	@Setter
	private FixedSizeIntList points;

    public CharTrieMapNode() {
		this.trie = new CharTrieMap();
    }
}
