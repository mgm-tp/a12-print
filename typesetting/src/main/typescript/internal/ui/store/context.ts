...
const initialTypesettingEditorContext: TypesettingEditorContext = {
	dispatch: () => {
		throw Error("Dispatch is not initilizes");
	},
};

export const TypesettingEditorContext = createContext(initialTypesettingEditorContext);
