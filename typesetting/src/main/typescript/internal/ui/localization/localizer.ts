...
export const DEFAULT_RESOURCES: LocalizationTreeMap = { en, de };

export const useDefaultLocalizer = (): Localizer => {
...
export const useLocalizer = () => {
	...
	return (key: string, args?: LocalizableArgs) => {
		return defaultLocalizer(localizableFromLocalizationTreeMap(key, DEFAULT_RESOURCES, args));
	};
};
