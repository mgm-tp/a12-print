...
export const TypesettingModelFooter = ({ footerSlots, onClickSave, disableSave }: TypesettingModelFooterProps) => {
	const localizer = useLocalizer();
	const { rightSlotButtons = [], leftSlotButtons = [] } = footerSlots || {};
	return (
		<ContentBoxElements.Footer>
			<ButtonGroupContainer
				...
				rightSlotButtons={[
					...rightSlotButtons,
					{
						label: localizer(RESOURCE_KEYS.button.save),
						primary: true,
