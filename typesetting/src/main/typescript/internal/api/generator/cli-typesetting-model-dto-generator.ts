...
if (inputFile && outputPath) {
	generateAndSaveDtoFiles(inputFile, outputPath, "TypesettingModel");
} else {
	throw new Error(
		"Please specify both typesetting_model_preprocessing_typesetting_model_file and typesetting_model_preprocessing_typescript_output_dir in package.json/config."
	);
}
