...
export class TypesettingModelValidator extends PrintValidator {
	private static instance: TypesettingModelValidator = new TypesettingModelValidator();
	...
	public static getInstance(): TypesettingModelValidator {
