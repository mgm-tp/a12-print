...
export class PreventLineBreakRuleDeserializer extends Deserializer<
	...
	ModelAPI.PreventLineBreakRule
> {
	prefix = "preventLineBreakRules";

	map(property: keyof GeneratedDTO.PreventLineBreakRulesDTO, dto: GeneratedDTO.PreventLineBreakRulesDTO) {
		switch (property) {
			case "pattern":
				return dto.pattern;
		}
