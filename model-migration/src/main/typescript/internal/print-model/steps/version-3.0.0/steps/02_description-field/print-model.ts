 ...
 */
// Automatically generated from DomainPrintMetaModel.json on 5/12/2025, 10:52:56 AM.
...
export interface ColorDTO {
	id: string;
	value?: string;
	source?: Enumeration_Color_SourceDTO;
	path: string;
}

export interface BackgroundColorDTO {
	id: string;
	value?: string;
	source?: Enumeration_BackgroundColor_SourceDTO;
	path: string;
}

export interface AlignmentDTO {
	id: string;
	source?: Enumeration_Alignment_SourceDTO;
	path: string;
	value?: Enumeration_Alignment_ValueDTO;
}

export interface BoldDTO {
	id: string;
	value?: boolean;
	source?: Enumeration_Bold_SourceDTO;
	path: string;
}

export interface ItalicDTO {
	id: string;
	value?: boolean;
	source?: Enumeration_Italic_SourceDTO;
	path: string;
}

export interface UnderlinedDTO {
	id: string;
	value?: boolean;
	source?: Enumeration_Underlined_SourceDTO;
	path: string;
}

export interface TextStyleIdDTO {
	id: string;
	value?: string;
	source?: Enumeration_TextStyleId_SourceDTO;
	path: string;
}
...
export interface HeaderTextPropertiesDTO {
	id: string;
	color?: ColorDTO;
	backgroundColor?: BackgroundColorDTO;
	alignment?: AlignmentDTO;
	bold?: BoldDTO;
	italic?: ItalicDTO;
	underlined?: UnderlinedDTO;
	textStyleId?: TextStyleIdDTO;
}
