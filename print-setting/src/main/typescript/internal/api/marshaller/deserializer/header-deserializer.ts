...
/**
 * Deserializer for PrintSettingModel headers.
 * Supports only annotations (no description, locales, labels, or modelReferences).
 */
export class PrintSettingHeaderDeserializer extends BaseHeaderDeserializer<
	GeneratedDTO.HeaderDTO,
	ModelAPI.PrintSettingHeader
> {
