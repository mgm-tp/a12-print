...
import { GlobalStyles } from "@com.mgmtp.a12.widgets/widgets-core/lib/theme/base/index.js";
import { flatCompactTheme } from "@com.mgmtp.a12.widgets/widgets-core/lib/theme/flat-compact/flat-compact-theme.js";
import { WidgetsRoot } from "@com.mgmtp.a12.widgets/widgets-core/lib/common/index.js";
...
import { PrintSettingModelValidator } from "../api/validation/print-setting-model-validator.js";

import { PrintSettingModelEditor } from "./app/index.js";
...
PrintSettingModelValidator.getInstance()
...
ReactDOM.createRoot(mountPoint!).render(<PrintSettingApp />);
