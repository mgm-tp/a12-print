...
import { PrintModelEditorLightWrapper } from "./print-model-editor-light/PrintModelEditorLightWrapper";
import { PrintModelEditorSMEWrapper } from "./print-model-editor-sme/PrintModelEditorSMEWrapper";
...
export function PrintEditor({
	...
	if (isBasicEditor) {
		...
		return (
			<PrintModelEditorSMEWrapper
				printModel={printModel}
				logPersistentEntries={logPersistentEntries}
				documentModels={documentModels}
				customFonts={customFonts}
				store={store}
				templatePrintModels={templatePrintModels}
