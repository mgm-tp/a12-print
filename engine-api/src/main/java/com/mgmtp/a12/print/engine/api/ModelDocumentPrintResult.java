...
public interface ModelDocumentPrintResult extends PrintResult {
    ...
    static ModelDocumentPrintResult empty() {
    	return new ModelDocumentPrintResult() {
			@Override
			public PrintModelDocument getPrintModelDocument() { return null;}

			@Override
			public void copyTo(OutputStream outputStream) throws PrintException {
				// ModelDocumentPrintResult has no need to be copied
			}
		};
	}

	PrintModelDocument getPrintModelDocument();

    @Override
	default String getContentType() {
		return "application/x-print-model-document";
	}
}
