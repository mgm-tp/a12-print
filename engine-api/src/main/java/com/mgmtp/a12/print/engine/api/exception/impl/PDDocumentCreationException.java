...
public class PDDocumentCreationException extends PrintException {
	...
	public PDDocumentCreationException(final String message, final Object... args) {
		super(message, args);
	}

	public PDDocumentCreationException(final String message, final Throwable throwable) {
