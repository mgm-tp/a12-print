...
public class MergedModelSegmentsTest {
	@Test
	public void testMergedModelSegmentsWithStaticTableElement() {
		...
		XmlRuntimeTestUtil.writeResultFiles(result, "mergedModelSegments");
