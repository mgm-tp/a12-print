...
public class TextElementXml extends TextBasedElementXml {
	public TextElementXml(
		String id,
		String value,
		String text,
		boolean isNested,
		...
		super(id, PrintElementTypeXml.TEXT, value, text, isNested, valueIsRenderedAsHtml, elements);
	}
