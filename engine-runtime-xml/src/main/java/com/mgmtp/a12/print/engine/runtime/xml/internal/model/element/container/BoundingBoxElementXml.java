...
public class BoundingBoxElementXml extends PrintElementNestedContainerXml {
	public BoundingBoxElementXml(
		String id,
		List<IPrintElementXml> elements
	) {
		super(id, PrintElementTypeXml.BOUNDING_BOX, elements);
	}
