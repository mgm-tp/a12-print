...
public class CalculationElementXml extends TextBasedElementXml {
	public CalculationElementXml(
		String id,
		String value,
		String text,
		boolean isNested,
		...
		super(id, PrintElementTypeXml.CALCULATION, value, text, isNested, valueIsRenderedAsHtml, null);
	}
