 ...
 */
package com.mgmtp.a12.print.engine.runtime.xml.internal.model.element.listing;
...
public class ListingElementXml extends PrintElementXml {
	...
	@XmlElement(name = "row")
	private List<ListingRowXml> rows;

	public ListingElementXml(
		String id,
		List<String> headerCells,
		List<ListingRowXml> rows
	) {
		super(id, PrintElementTypeXml.LISTING);
		this.rows = rows;
