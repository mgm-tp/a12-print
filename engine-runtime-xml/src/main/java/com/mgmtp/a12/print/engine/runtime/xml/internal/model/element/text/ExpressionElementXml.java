...
public class ExpressionElementXml extends TextBasedElementXml {
	public ExpressionElementXml(
		String id,
		String value,
		String text,
		boolean isNested
	) {
		super(id, PrintElementTypeXml.EXPRESSION, value, text, isNested, true, null);
	}
