...
public class FieldElementXml extends TextBasedElementXml {
	public FieldElementXml(
		String id,
		String value,
		String text,
		boolean isNested,
		...
		super(id, PrintElementTypeXml.FIELD, value, text, isNested, valueIsRenderedAsHtml, null);
	}
