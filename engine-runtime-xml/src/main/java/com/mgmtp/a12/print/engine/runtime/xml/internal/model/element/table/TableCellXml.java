...
import com.mgmtp.a12.print.engine.runtime.xml.internal.model.element.text.FieldElementXml;
import jakarta.xml.bind.annotation.XmlElementRef;
import jakarta.xml.bind.annotation.XmlElementRefs;
import jakarta.xml.bind.annotation.XmlRootElement;

@XmlRootElement
public class TableCellXml implements ITableCellXml {
	@XmlElementRefs({
		@XmlElementRef(type= FieldElementXml.class),
		@XmlElementRef(type= ExpressionElementXml.class),
	})
	private IPrintElementXml content;

	public TableCellXml(
		IPrintElementXml content
	) {
