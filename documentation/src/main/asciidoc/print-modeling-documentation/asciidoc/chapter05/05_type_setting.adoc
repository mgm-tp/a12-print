...
+
image::chapter05/Typesetting_ReferenceModel.png[Referencing Typesetting Model,title="Referencing Typesetting Model"]
+
3. Create a Text Style and <<TypographySettings,reference>> the Typesetting Model.
+
image::chapter05/Typesetting_TextStyleReference.png[Text Style with Typesetting Model,title="Text Style with Typesetting Model"]
+
...
image::chapter05/Typesetting_CharacterSequence.png[Character Sequence Rules,title="Character Sequence Rules"]
...
image::chapter05/Typesetting_NumberUnitRule.png[Number Unit Rules,title="Number Unit Rules"]
...
image::chapter05/Typesetting_SpecialPatternRule.png[Special Pattern Rules,title="Special Pattern Rules"]
...
image::chapter05/Typesetting_OrphanWidowSetting.png[Widow and Orphan Settings,title="Widow and Orphan Settings."]

image::chapter05/Typesetting_OrphanWidow2.png[Widow and Orphan Example (Default limit),title="Widow and Orphan Example (Default limit)."]

image::chapter05/Typesetting_OrphanWidow5.png[Orphan and Widow Example with limit set to 5,title="Orphan and Widow Example with limit set to 5."]
