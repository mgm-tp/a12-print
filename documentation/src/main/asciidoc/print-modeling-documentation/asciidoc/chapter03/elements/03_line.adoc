...
The properties of the Line element are determined by its <<BorderProperties, Border Properties>>.

NOTE: The *Border Style* of a Line element is always required — the *Unset* source is not available.
New Line elements are created with *Border Style* set to *Solid* by default.
