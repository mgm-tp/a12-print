...
If your want to integrate this component or if your project has other requirements, feel free to contact the A12 Print Engine team (link:https://discourse.geta12.com/c/engines-specific/print-engine[Discourse])
