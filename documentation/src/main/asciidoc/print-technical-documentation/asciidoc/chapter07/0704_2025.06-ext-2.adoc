...
* `com.mgmtp.a12.print.engine.runtime.pdf.PdfPrintEngine` is deprecated and will be removed within the 2026.06 release. Please use `com.mgmtp.a12.print.engine.runtime.pdfBox.PdfBoxPrintEngine` instead. The new engine is not able to provide HTML anymore and the PDF output differs.
