...
export interface PageNumber extends PrintModelElement {
	readonly type: ElementType.PageNumber;
}

export namespace PageNumber {
	export function isInstance(element: PartialAnyPrintModelElement): element is PageNumber {
