...
import type { Styleable } from "../base.js";
import type { PrintModelElement } from "../print-model-element.js";
import { ElementType } from "../print-model-element.js";

export interface Line extends PrintModelElement, Styleable {
	readonly type: ElementType.Line;
}

export namespace Line {
	export function isInstance(element: PartialAnyPrintModelElement): element is Line {
