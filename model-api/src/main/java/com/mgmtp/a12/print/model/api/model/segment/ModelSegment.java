...
public interface ModelSegment extends TopLevelReferenceContainer {
	...
	ModelSegmentType getType();

	Optional<ModelSegmentProperties> getSegmentProperties();

	Optional<ModelSegmentReference> getDinTemplate();
	...
	@Override
	default PageOrientation getPageOrientation() {
		return getSegmentProperties().isPresent()
			? getSegmentProperties().get().getPageOrientation()
