...
import com.mgmtp.a12.print.model.api.model.container.TableColumnReferenceContainer;
...
public interface Table extends PrintModelElement, Styleable, TableColumnReferenceContainer {
	...
	@Override
	default Collection<TableColumnReference> getReferences() {
		return getTableProperties().getColumns();
	}
}
