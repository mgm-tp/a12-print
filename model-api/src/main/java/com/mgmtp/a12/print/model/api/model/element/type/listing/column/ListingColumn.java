...
public interface ListingColumn extends PrintModelEntity, PrintModelPathElement {
	...
	Optional<Boolean> isSortingIndex();
	Optional<Boolean> hasCustomTextProperties();
	Optional<Boolean> hasCustomBorderProperties();

	Optional<ColumnProperties> getDefaultProperties();
	Optional<ColumnProperties> getGroupProperties();

	List<FieldProperties> getFieldProperties();
