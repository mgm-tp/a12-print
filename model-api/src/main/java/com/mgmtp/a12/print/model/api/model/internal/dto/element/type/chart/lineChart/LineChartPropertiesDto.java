 ...
 */
package com.mgmtp.a12.print.model.api.model.internal.dto.element.type.chart.lineChart;
...
public class LineChartPropertiesDto extends ChartPropertiesDto implements LineChartProperties, JsonModel {
	@JsonProperty("labelX")
	@JsonDeserialize(as = StringInputSourceDto.class)
	StringInputSource labelX;

	@JsonProperty("labelY")
	@JsonDeserialize(as = StringInputSourceDto.class)
	StringInputSource labelY;

	@JsonProperty(value = "orientation", required = true)
	ChartOrientation orientation;

	@JsonProperty("data")
	@JsonDeserialize(contentAs = LineChartDataDto.class)
	@Builder.Default
