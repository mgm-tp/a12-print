...
public class TextElementPropertiesDto extends PrintModelEntityDto implements TextElementProperties, JsonModel {
	...
	@JsonDeserialize(contentAs = ElementReferenceDto.class)
	@Builder.Default
	Collection<ElementReference> entities = new ArrayList<>();

	@Override
	public Optional<Boolean> hideIfEmpty() {
		return Optional.ofNullable(hideIfEmpty);
	}
}
