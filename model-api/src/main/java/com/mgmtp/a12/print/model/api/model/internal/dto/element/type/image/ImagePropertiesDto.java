...
public class ImagePropertiesDto extends PrintModelEntityDto implements ImageProperties, JsonModel {
	@JsonProperty(value = "imageSrcType", required = true)
	ImageSrcType imageSrcType;

	@JsonProperty(value = "alternativeText", required = true)
