 ...
 */
package com.mgmtp.a12.print.model.api.model.element.type.table;
...
public interface TableProperties extends PrintModelEntity {
	String getModel();
	String getBasePath();
	IntegerInputSource getMaxRowCount();
	Optional<String> getFilterExpression();
	Optional<Boolean> hideHeader();
	StringInputSource getSumLabel();
	Optional<TextProperties> getHeaderTextProperties();
	Collection<TableColumnReference> getColumns();
}
