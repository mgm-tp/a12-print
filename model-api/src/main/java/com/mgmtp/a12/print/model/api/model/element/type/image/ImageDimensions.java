...
@OnlyForUsage
public interface ImageDimensions extends PrintModelEntity {
	Optional<Measure> getWidth();

	Optional<Measure> getHeight();

	Optional<Measure> getOriginalWidth();

	Optional<Measure> getOriginalHeight();
}
