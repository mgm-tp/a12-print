 ...
 */
package com.mgmtp.a12.print.model.api.model.internal.dto.element.type.chart.barChart;
...
public class BarChartPropertiesDto extends ChartPropertiesDto implements BarChartProperties, JsonModel {
	@JsonProperty("labelX")
	...
	@JsonProperty("data")
	@JsonDeserialize(contentAs = BarChartDataDto.class)
	@Builder.Default
