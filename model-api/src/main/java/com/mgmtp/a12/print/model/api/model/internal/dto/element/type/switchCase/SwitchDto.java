...
public class SwitchDto extends PrintModelElementDto implements Switch, JsonModel {
	@JsonProperty(value = "switch", required = true)
	@JsonDeserialize(as = SwitchPropertiesDto.class)
	SwitchProperties switchProperties;

	@Override
	@JsonIgnore
	public List<ElementReference> getReferences() {
		return Switch.super.getReferences();
	}
}
