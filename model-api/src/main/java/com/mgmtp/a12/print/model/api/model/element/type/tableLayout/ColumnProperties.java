...
public interface ColumnProperties extends IndexedProperties {
	...
	enum VerticalAlignment implements InputSourceEnum {
		...
		private static final Map<String, VerticalAlignment> STRING_TO_ENUM = InputSourceEnum.buildStringToEnumMap(VerticalAlignment.class);

		@Getter
		private final String jsonValue;

		VerticalAlignment(String jsonPropertyValue) {
			this.jsonValue = jsonPropertyValue;
		}

		public static VerticalAlignment fromString(String text) {
