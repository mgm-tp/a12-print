...
public class ChartDataDto extends PrintModelEntityDto implements ChartData, JsonModel {
	@JsonProperty(value = "valueField", required = true)
	private final String valueField;
	@JsonProperty("labelIsNumeration")
	private final Boolean labelIsNumeration;

	@Override
	public Optional<Boolean> labelIsNumeration() {
		return Optional.ofNullable(labelIsNumeration);
	}
}
