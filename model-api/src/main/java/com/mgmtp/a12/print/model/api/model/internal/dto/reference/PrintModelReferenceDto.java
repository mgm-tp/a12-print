...
public class PrintModelReferenceDto extends PrintModelEntityDto implements PrintModelReference {
	@JsonProperty(value = "purpose", required = true)
	ModelReferencePurpose purpose;

	@JsonProperty(value = "direction", required = true)
	ModelReferenceDirection direction;

	@JsonProperty(value = "referenceModel", required = true)
	String referenceModel;

	@JsonProperty("refIds")
	@JsonDeserialize(contentAs = ElementReferenceDto.class)
	@Builder.Default
	List<ElementReference> refIds = new ArrayList<>();
}
