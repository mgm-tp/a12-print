...
public class ImageDimensionsDto extends PrintModelEntityDto implements ImageDimensions, JsonModel {
	@JsonProperty("height")
	...
	@JsonDeserialize(as = MeasureDto.class)
	Measure originalHeight;

	@JsonProperty("originalWidth")
	@JsonDeserialize(as = MeasureDto.class)
	Measure originalWidth;

	public Optional<Measure> getHeight() {
		return Optional.ofNullable(height);
	}
	public Optional<Measure> getWidth() {
		return Optional.ofNullable(width);
	}
	public Optional<Measure> getOriginalHeight() {
		return Optional.ofNullable(originalHeight);
	}
	public Optional<Measure> getOriginalWidth() {
