...
public class OverrideElementDto extends PrintModelElementDto implements OverrideElement {

	@JsonProperty("override")
	@JsonDeserialize(as = OverridePropertiesDto.class)
	OverrideProperties overrideProperties;

	@Override
	@JsonIgnore
	public List<PlaceableReference> getReferences() {
		return OverrideElement.super.getReferences();
	}
}
