 ...
 */
package com.mgmtp.a12.print.model.api.model.element.type.boundingBox;
...
@OnlyForUsage
public interface BoundingBox extends PrintModelElement, PlaceableReferenceContainer {
	BoundingBoxProperties getBoundingBoxProperties();
	Optional<BorderProperties> getBorderProperties();

	@Override
	default List<PlaceableReference> getReferences() {
		return getBoundingBoxProperties().getElementReferences();
	}
}
