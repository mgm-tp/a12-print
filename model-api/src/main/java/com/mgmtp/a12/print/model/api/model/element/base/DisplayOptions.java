...
public interface DisplayOptions extends PrintModelEntity {
	...
	enum DisplayType {
		...
		@JsonProperty("DateRange") DATE_RANGE,
		@JsonProperty("Checkbox") CHECKBOX,
	}

	Optional<String> getDateFormat();
	Optional<String> getDateRangeFormatStart();
	Optional<String> getDateRangeFormatEnd();
	Optional<String> getDateRangeDelimiter();
	Optional<String> getCheckboxChecked();
	Optional<String> getCheckboxUnchecked();
