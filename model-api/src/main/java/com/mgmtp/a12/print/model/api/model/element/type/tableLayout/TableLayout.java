...
import com.mgmtp.a12.print.model.api.model.container.TableLayoutCellReferenceContainer;
...
public interface TableLayout extends PrintModelElement, Styleable, TableLayoutCellReferenceContainer {
	...
	@Override
	default List<TableLayoutCellReference> getReferences() {
		return getTableLayoutProperties().getCells();
	}
}
