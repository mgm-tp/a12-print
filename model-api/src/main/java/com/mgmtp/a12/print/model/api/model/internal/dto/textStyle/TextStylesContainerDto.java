...
public class TextStylesContainerDto extends PrintModelEntityDto implements TextStylesContainer, JsonModel {
	@JsonProperty(value = "definitions")
	@JsonDeserialize(contentAs = TextStyleDto.class)
	@Builder.Default
	List<TextStyle> definitions = new ArrayList<>();
}
