...
public class DocumentModelResolver implements IDocumentModelResolver {
	...
	private static final String PRINT_META_MODEL_PATH = "/DomainPrintMetaModel.json";
	...
	@Override
	public IDocumentModel getDocumentModelById(String ignored) {
		try {
			String model = ResourceFile.loadFileFromResources(PRINT_META_MODEL_PATH);
