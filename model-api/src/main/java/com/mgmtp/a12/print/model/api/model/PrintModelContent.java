...
public interface PrintModelContent extends Content, PrintModelPathElement, PrintModelEntity {
	...
	List<PrintModelElement> getElementDefinitions();

	Optional<TextStylesContainer> getTextStyles();

	Optional<ModelSectionContainer> getSections();

	Optional<WatermarkContainer> getWatermarks();

	ModelSegmentContainer getSegments();
}
