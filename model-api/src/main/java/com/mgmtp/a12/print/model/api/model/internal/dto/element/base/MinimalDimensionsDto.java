...
public class MinimalDimensionsDto extends PrintModelEntityDto implements Dimensions, JsonModel {
	@JsonProperty(value = "minWidth", required = true)
	@JsonDeserialize(as = MeasureDto.class)
	Measure width;

	@JsonProperty(value = "minHeight", required = true)
	@JsonDeserialize(as = MeasureDto.class)
	Measure height;
