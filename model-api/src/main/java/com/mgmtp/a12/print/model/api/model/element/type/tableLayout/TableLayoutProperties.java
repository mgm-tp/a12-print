...
@OnlyForUsage
public interface TableLayoutProperties extends PrintModelEntity {
	Integer getRowCount();
	Integer getColumnCount();
	List<RowProperties> getRowProperties();
	List<ColumnProperties> getColumnProperties();

	List<TableLayoutCellReference> getCells();
}
