...
public interface ColumnProperties extends PrintModelEntity, LogicContainer {
	List<ColumnPropertyComputation> getPropertyComputations();

	List<ComputationAlternative> getValueComputationAlternatives();

	@Override
	default Stream<LogicComponent> logicComponents() {
		return getValueComputationAlternatives().stream().map(e -> e);
	}
