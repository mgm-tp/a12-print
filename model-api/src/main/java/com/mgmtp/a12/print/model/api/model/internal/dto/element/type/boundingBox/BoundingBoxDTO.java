 ...
 */
package com.mgmtp.a12.print.model.api.model.internal.dto.element.type.boundingBox;
...
import com.mgmtp.a12.print.model.api.model.element.type.boundingBox.BoundingBoxProperties;
...
public class BoundingBoxDTO extends PrintModelElementDto implements BoundingBox, JsonModel {
	@JsonProperty(value = "boundingBox", required = true)
	@JsonDeserialize(as = BoundingBoxPropertiesDTO.class)
	...
	public List<PlaceableReference> getReferences() {
		return BoundingBox.super.getReferences();
	}
}
