...
public class TableDto extends StyleablePrintModelElementDto implements Table, JsonModel {

	@JsonProperty(value = "table", required = true)
	@JsonDeserialize(as = TablePropertiesDto.class)
	TableProperties tableProperties;

	@Override
	@JsonIgnore
	public Collection<TableColumnReference> getReferences() {
		return Table.super.getReferences();
	}
}
