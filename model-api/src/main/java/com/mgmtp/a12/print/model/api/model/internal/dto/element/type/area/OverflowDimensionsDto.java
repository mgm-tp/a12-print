...
public class OverflowDimensionsDto extends DimensionsDto implements OverflowDimensions, JsonModel {
	@JsonProperty(value = "overflowHeight", required = true)
	@JsonDeserialize(as = MeasureDto.class)
	Measure overflowHeight;
}
