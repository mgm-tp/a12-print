 ...
 */
package com.mgmtp.a12.print.model.api.model.internal.dto.watermark;
...
import com.mgmtp.a12.print.model.api.model.watermark.WatermarkCondition;
...
public class WatermarkDto extends PrintModelEntityDto implements Watermark, JsonModel {
	@JsonProperty(value = "title", required = true)
	String title;

	@JsonProperty(value = "pageOrientation", required = true)
	...
	@JsonDeserialize(contentAs = WatermarkConditionDto.class)
	@Builder.Default
	Collection<WatermarkCondition> conditions = new ArrayList<>();

	@JsonProperty("elementReferences")
	@JsonDeserialize(contentAs = PlaceableReferenceDto.class)
	@Builder.Default
	Collection<PlaceableReference> references = new ArrayList<>();
