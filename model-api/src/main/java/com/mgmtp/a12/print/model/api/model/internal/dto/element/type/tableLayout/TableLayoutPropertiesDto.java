...
import com.mgmtp.a12.print.model.api.model.internal.dto.reference.TableLayoutCellReferenceDto;
import lombok.*;
...
public class TableLayoutPropertiesDto extends PrintModelEntityDto implements TableLayoutProperties, JsonModel {
	...
	@JsonDeserialize(contentAs = RowPropertiesDto.class)
	@Builder.Default
	List<RowProperties> rowProperties = new ArrayList<>();

	@JsonProperty("columnProperties")
	@JsonDeserialize(contentAs = ColumnPropertiesDto.class)
	@Builder.Default
	List<ColumnProperties> columnProperties = new ArrayList<>();

	@JsonProperty("cells")
	@JsonDeserialize(contentAs = TableLayoutCellReferenceDto.class)
	@Builder.Default
	List<TableLayoutCellReference> cells = new ArrayList<>();
}
