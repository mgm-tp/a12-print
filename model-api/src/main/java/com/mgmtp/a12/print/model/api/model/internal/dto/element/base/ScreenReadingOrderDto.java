...
public class ScreenReadingOrderDto extends PrintModelEntityDto implements ScreenReadingOrder, JsonModel {
	@JsonProperty(value = "screenReadingOrderWeight", required = true)
