...
public class OverridePropertiesDto extends PrintModelEntityDto implements OverrideProperties {
	@JsonProperty("refId")
	String refId;

	@JsonProperty(value = "overrideType", required = true)
	OverrideType overrideType;

	@JsonProperty("source")
	@JsonDeserialize(as = OverrideSourceDto.class)
	OverrideSource source;

	@JsonProperty("boundingBox")
	@JsonDeserialize(as = OverrideBoundingBoxPropertiesDto.class)
	OverrideBoundingBoxProperties boundingBoxProperties;
}
