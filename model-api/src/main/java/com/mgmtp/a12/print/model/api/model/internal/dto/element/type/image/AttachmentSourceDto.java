...
import com.mgmtp.a12.print.model.api.model.internal.dto.element.base.AttachmentDto;
...
public class AttachmentSourceDto extends PrintModelEntityDto implements AttachmentSource, JsonModel {
	@JsonProperty(value = "imageAttachment", required = true)
  	AttachmentDto imageAttachment;
}
