...
public class CalculationDto extends PrintModelElementDto implements Calculation, JsonModel {
	@JsonProperty(value = "calculation", required = true)
	@JsonDeserialize(as = CalculationPropertiesDto.class)
