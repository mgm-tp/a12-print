...
public interface BorderProperties extends PrintModelEntity {
	...
	enum BorderStyle implements InputSourceEnum {
		...
		@JsonProperty("Dashed") DASHED("Dashed");

		private static final Map<String, BorderStyle> STRING_TO_ENUM = InputSourceEnum.buildStringToEnumMap(BorderStyle.class);

		@Getter
		private final String jsonValue;

		BorderStyle(String jsonPropertyValue) {
			this.jsonValue = jsonPropertyValue;
		}

		public static BorderStyle fromString(String text) {
