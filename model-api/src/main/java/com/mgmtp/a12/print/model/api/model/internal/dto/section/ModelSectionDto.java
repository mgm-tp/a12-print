 ...
 */
package com.mgmtp.a12.print.model.api.model.internal.dto.section;
...
public class ModelSectionDto extends PrintModelEntityDto implements ModelSection, JsonModel {
	...
	@JsonProperty(value = "sectionUsage", required = true)
	...
	@Override
	@JsonIgnore
	public int getActualFooterHeight() {
		return ModelSection.super.getActualFooterHeight();
	}
}
