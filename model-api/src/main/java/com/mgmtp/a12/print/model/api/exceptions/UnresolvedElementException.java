...
public class UnresolvedElementException extends RuntimeException {
	...
	public UnresolvedElementException(final ElementReference reference, final int index) {
		super(String.format("Could not resolve element reference: %s at index: %s", reference.getRefId(), index));
	}
}
