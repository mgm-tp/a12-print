 ...
 */
package com.mgmtp.a12.print.model.api.model.element.type.text;


import com.mgmtp.a12.print.model.api.model.container.ElementReferenceContainer;
...
public interface TextElement extends PrintModelElement, Styleable, ElementReferenceContainer {
	...
	@Override
	default Collection<ElementReference> getReferences() {
		return getTextElementProperties().getEntities();
	}
}
