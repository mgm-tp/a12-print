...
class CustomDocumentModelReferenceResolverTest {
    @Mock
    ...
    @Spy
    @InjectMocks
    private CustomDocumentModelReferenceResolver underTest;

    @Test
    void testGetDocumentModel() {
    ...
    @Test
    void testIdFromReference() {
        final var result = CustomDocumentModelReferenceResolver.idFromReference("TestFieldDM.json");
