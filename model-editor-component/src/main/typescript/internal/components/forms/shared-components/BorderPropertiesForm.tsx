...
export const BorderPropertiesForm = (props: BorderPropertiesFormProps) => {
	const localizer = PrintLocalizer.useLocalizer();

	return (
		<>
			{!props.hideLabel && (
				<FormContainerHeadline label={localizer(RESOURCE_KEYS.elementForm.borderProperties.headline)} />
			)}
			<BorderForm {...props} />
		</>
	);
