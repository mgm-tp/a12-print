...
export interface DateFormatInputProps {
...
export const DateFormatInput = ({
	...
	onBlur,
	errorMessage,
	label = RESOURCE_KEYS.elementForm.field.dateFormat,
}: DateFormatInputProps): React.ReactElement => {
	...
	return (
		<DynamicSourceTextField
			...
			addonAfter={
				<Button
					icon={<Icon>info</Icon>}
					title={localizer(RESOURCE_KEYS.elementForm.field.dateFormatHint)}
