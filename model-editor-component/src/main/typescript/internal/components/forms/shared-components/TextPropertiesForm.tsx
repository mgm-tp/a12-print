...
export const TextPropertiesForm = (props: TextPropertiesFormProps) => {
	const localizer = PrintLocalizer.useLocalizer();

	const { hideLabel, ...propertiesFormProps } = props;
	return (
		<>
			{!hideLabel && (
				<FormContainerHeadline
					label={props.label || localizer(RESOURCE_KEYS.elementForm.textProperties.headline)}
				/>
			)}
			<TextPropertiesInput {...propertiesFormProps} propertiesPath={TEXT_PROPERTIES_PATH} />
		</>
	);
};
