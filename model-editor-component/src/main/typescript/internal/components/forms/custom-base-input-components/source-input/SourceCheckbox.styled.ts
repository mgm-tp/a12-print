...
export const StyleSourceCheckbox = styled.div`
	display: flex;
	width: 100%;
	${StyledCustomToggle} {
		max-width: 100px;
...
export const StyleCheckboxIndeterminate = styled(Checkbox.Indeterminate)`
	display: flex;
	align-items: center;
`;

export const StyleCheckboxGroup = styled.div`
	display: flex;
	gap: 10px;
	flex-wrap: wrap;
