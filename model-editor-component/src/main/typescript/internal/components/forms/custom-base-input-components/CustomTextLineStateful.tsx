...
export const CustomTextLineStateful = (props: TextLineStatefulProps) => {
	...
	return sourceProperties ? (
		...
		<CustomTextLineStateless {...restProps} value={value} onChange={handleOnChange} onBlur={handleOnBlur} />
	);
};
