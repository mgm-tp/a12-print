		...
		<>
			{showBorders && (
				<StyledButton
					label={localizer(
						isMarginVisible
							? RESOURCE_KEYS.editor.topMenu.hideMargins
							: RESOURCE_KEYS.editor.topMenu.showMargins
					)}
					onClick={() => dispatch(EditorStateActions.update({ isMarginVisible: !isMarginVisible }))}
