...
import { DraftDecoratorComponentProps } from "@com.mgmtp.a12.widgets/widgets-draft-js-editor";
...
export type DraftDecoratorComponentPropsExtended = DraftDecoratorComponentProps & {
	blockKey: string;
	start: number;
	end: number;
};
