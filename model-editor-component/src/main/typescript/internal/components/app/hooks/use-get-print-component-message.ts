...
export function useGetPrintComponentMessage() {
	return useCallback((localizer: Localizer, key: string, args?: LocalizableArgs) => {
		return localizer(localizableFromLocalizationTreeMap(key, PRINT_DEFAULT_TRANSLATIONS, args)) || key;
	}, []);
}
