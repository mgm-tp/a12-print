...
export interface ErrorTreeNode extends CollapsibleTreeNodeModel, SelectableTreeNodeModel {
	...
	errorData?: PrintError & { navigation?: NavigationTarget };
	path?: string;
}

export interface NavigationTarget {
	sidebarTarget: SidebarItem;
	containerTarget?: string;
	elementTargets?: ElementNavigationTarget[];
}

export interface ElementNavigationTarget {
	elementRef: string;
