...
export namespace DocumentModelDataSelectors {
	...
	export const documentModelData: Selector<PrintEngineState, DocumentModelData | undefined> = createSelector(
		[documentModelDataState, (_state, id?: string) => id],
		(state, documentModelId) => {
			return documentModelId && state ? state[documentModelId] : undefined;
		}
	);
}
