...
export interface ContextApi {
	...
	getFonts: IGetFonts;
	discardAllChangesPossible?: boolean;
}

export const defaultContextApi: ContextApi = {
	localizer: (key: string) => key,
	getFonts: () => ({}),
};

export const EditorComponentContext = React.createContext<ContextApi>(defaultContextApi);
