...
export const modelApiImportMigrationConfig: ImportMigrationConfiguration = {
	pathMigrations: [
		{
			from: `${packageName}/lib/constant/**`,
			to: `${packageName}/constant`,
		},
		{
		...
		{
			from: `${packageName}/lib/generated/internal/**`,
			to: `${packageName}/generated/a12internal`,
		},
		{
