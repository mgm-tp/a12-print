...
import {
	migrateImports,
	type EntityMigrationConfiguration,
...
import { typesettingImportMigrationConfiguration } from "./importMigrationConfigs/typesetting.js";
import { printSettingImportMigrationConfiguration } from "./importMigrationConfigs/print-setting.js";

const migrationConfig: ImportMigrationConfiguration = {
	entityMigrations: [
		...(modelEditorComponentImportMigrationConfig.entityMigrations as EntityMigrationConfiguration[]),
	],
	pathMigrations: [
		...
		...(typesettingImportMigrationConfiguration.pathMigrations as PathMigrationConfiguration[]),
		...(printSettingImportMigrationConfiguration.pathMigrations as PathMigrationConfiguration[]),
	],
};
