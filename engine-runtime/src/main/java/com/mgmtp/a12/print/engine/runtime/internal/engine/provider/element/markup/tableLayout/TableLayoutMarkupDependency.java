...
public class TableLayoutMarkupDependency implements ValueDependency<MarkupResult> {
	private final PrintModelTreeTrace<TableLayout> tableLayoutTrace;
	private final ValueFactory<List<TableLayoutRow>> rows;
}
