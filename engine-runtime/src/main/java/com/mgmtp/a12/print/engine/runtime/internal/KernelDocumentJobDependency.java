...
public class KernelDocumentJobDependency implements JobDependency {

	private final DocumentDependencyDescriptor dataDependencyDescriptor;

	@Override
	public DocumentDependencyDescriptor getDescriptor() {
