...
public class PDSegmentObject extends PDDocumentContainer {
	@NonNull
	List<SortablePDDocument> sortablePDDocuments;
	MatchingSections matchingSections;

	public PDSegmentObject(
		final @NonNull List<SortablePDDocument> sortablePDDocuments,
		final MatchingSections matchingSections
	) {
		super(sortablePDDocuments);
