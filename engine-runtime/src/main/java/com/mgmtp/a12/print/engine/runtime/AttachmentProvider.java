...
public interface AttachmentProvider extends JobDependencyProvider {
	...
	static AttachmentProvider fromLoader(final @NonNull Function<String, ByteArrayInputStream> loading) {
	...
	/**
	 * @return true, if the Attachment referenced by the ID is supported by the provider.
	 */
