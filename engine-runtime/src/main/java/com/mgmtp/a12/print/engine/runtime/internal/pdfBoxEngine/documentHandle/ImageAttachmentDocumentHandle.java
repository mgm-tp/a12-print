...
@Value
public class ImageAttachmentDocumentHandle implements ContainerDocumentHandle {
	@NonNull
	PDDocument document;

	public ImageAttachmentDocumentHandle(@NonNull PDDocument pdDocument) {
		this.document = pdDocument;
	}

	@Override
	public RegionCursor getInitialRegionCursor(@NonNull Position position) {
		final var contentStreamAdapter = new ContentStreamAdapter(
			document,
