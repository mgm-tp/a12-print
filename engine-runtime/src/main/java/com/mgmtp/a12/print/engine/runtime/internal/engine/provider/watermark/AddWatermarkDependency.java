...
public class AddWatermarkDependency implements ValueDependency<AddWatermarkResult> {
	private final @NonNull PDDocument originPdDocument;
	private final @NonNull List<ModelSegmentPrintResult> watermarkPrintResults;
