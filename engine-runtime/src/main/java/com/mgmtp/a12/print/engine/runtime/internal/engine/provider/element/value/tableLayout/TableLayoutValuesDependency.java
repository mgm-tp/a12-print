...
public class TableLayoutValuesDependency implements ValueDependency<List<TableLayoutRow>> {
	private final PrintModelTreeTrace<TableLayout> tableLayout;
	private final CellContentProvider contentProvider;

	@FunctionalInterface
	public interface CellContentProvider {
		IContentHolder provideCellContent(
			@NonNull final PrintModelTreeTrace<? extends ElementReference> reference
		);
	}
}
