...
public class AttachmentJobDependency implements JobDependency {

	private final AttachmentDependencyDescriptor attachmentDependency;

	@Override
	public AttachmentDependencyDescriptor getDescriptor() {
	...
	public Optional<ByteArrayInputStream> getAttachment() {
