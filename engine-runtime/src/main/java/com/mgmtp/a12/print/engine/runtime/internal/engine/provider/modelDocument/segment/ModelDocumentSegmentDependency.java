...
public class ModelDocumentSegmentDependency implements ValueDependency<AttachmentWrapper<ModelDocumentSegmentResult>>, ContainerProviderDependency {
	private final PrintModelTreeTrace<ModelSegment> segment;
	private final PrintDocumentContext documentContext;
	private final Collection<PrintModelTreeTrace<PlaceableReference>> references;

	private List<ModelDocumentPrintEngine.OverriddenBoundingBoxes> overriddenBoundingBoxes;
}
