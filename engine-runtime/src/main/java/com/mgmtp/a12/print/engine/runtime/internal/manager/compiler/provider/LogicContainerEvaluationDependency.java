...
@PrintEngineRuntimeStreamDependency(type = RuntimeType.CORE)
public class LogicContainerEvaluationDependency implements ValueDependency<LogicContainerEvaluation> {
	@NonNull
	private final PrintModelTreeTrace<? extends LogicContainer> logicContainer;
	private final ComputationExpression.Parameters parameters;

	public LogicContainerEvaluationDependency(@NonNull PrintModelTreeTrace<? extends LogicContainer> logicContainer, ComputationExpression.Parameters parameters) {
