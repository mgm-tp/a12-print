...
public class InsertPDObjectsDependency implements ValueDependency<InsertPDObjectsResult> {
	private final PrintDocumentContext printDocumentContext;
	@NonNull
	private final List<ModelSegmentPrintResult> modelSegmentPrintResults;
	private final int totalPageCount;
	@NonNull
	private final List<String> sectionsToRenderPerPage;
