...
public interface Component {
	...
	ComponentResult render(@NonNull RegionCursor regionCursor, boolean preventPageBreak);
	PreflightedComponent preflight(@NonNull RegionCursor regionCursor, boolean preventPageBreak);
	boolean isLocatedOnPageBreak(@NonNull RegionCursor regionCursor);
}
