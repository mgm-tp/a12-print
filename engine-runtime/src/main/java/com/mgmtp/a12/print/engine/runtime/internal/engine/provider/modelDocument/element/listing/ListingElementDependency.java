...
public class ListingElementDependency implements ValueDependency<AttachmentWrapper<IPrintElement>> {
	private final PrintModelTreeTrace<Listing> listingLayoutTrace;
	private final ListingValueResult valueResult;
}
