...
public class ExpressionValueDependency implements ValueDependency<Optional<String>> {
	private PrintModelTreeTrace<Expression> expression;
	private ExpressionEntitiesContentProvider expressionEntitiesContentProvider;

	@FunctionalInterface
	public interface ExpressionEntitiesContentProvider {
		List<TextValueMarkup> provideExpressionEntitiesContent(
			@NonNull final List<PrintModelTreeTrace<PrintModelElement>> traces
		);
	}
}
