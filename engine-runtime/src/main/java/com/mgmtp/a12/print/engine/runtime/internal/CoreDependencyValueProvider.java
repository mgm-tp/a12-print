...
@FunctionalInterface
public interface CoreDependencyValueProvider<Value, Dependency extends ValueDependency<Value>> extends GenericDependencyValueProvider<Value, Dependency, PrintJob, PrintEngine<?>, InternalCorePrintEngineRuntime> {
