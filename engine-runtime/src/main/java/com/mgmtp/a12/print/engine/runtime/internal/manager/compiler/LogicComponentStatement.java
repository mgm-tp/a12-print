...
@Data
@Builder
public class LogicComponentStatement {

	@NonNull
	private final ComputationFieldType fieldType;
	@NonNull
	private final ComputationSyntaxTree tree;
	@NonNull
	private final EggNode node;

	@EqualsAndHashCode.Exclude
	private ComputationEvaluationAdvice advice;
