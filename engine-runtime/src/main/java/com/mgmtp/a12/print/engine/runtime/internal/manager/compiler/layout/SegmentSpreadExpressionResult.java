...
public class SegmentSpreadExpressionResult extends SpreadExpressionResult {
	@NonNull
	String markup;

	public SegmentSpreadExpressionResult(
		...
		super(spreadExpressionId, sortablePDDocument, spread, gravitationYPosition, originYPosition, attachmentsToAppend, pageNumberGlobalStyles);
		this.markup = markup;
	}
}
