...
public enum SyntheticVariableType {
	NOT_FILLED_FIELD,
	FIELD,
	META,
	PREDICATE,
	...
	public ComputationFieldType getComputationFieldType() {
		return switch (this) {
			case EQUALITY, UN_EQUALITY, GREATER_THAN, GREATER_THAN_OR_EQUAL, LESS_THAN, LESS_THAN_OR_EQUAL, AND, OR ->
				ComputationFieldType.BOOLEAN;
			case NOT_FILLED_FIELD -> ComputationFieldType.EMPTY;
			default -> ComputationFieldType.UNKNOWN;
		};
	}
}
