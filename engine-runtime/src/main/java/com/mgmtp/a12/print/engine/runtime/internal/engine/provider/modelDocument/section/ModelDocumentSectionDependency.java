...
public class ModelDocumentSectionDependency implements ValueDependency<AttachmentWrapper<ModelDocumentSectionResult>>, ContainerProviderDependency {
	private final PrintModelTreeTrace<ModelSection> section;
