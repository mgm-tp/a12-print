...
public interface TextWidthResolver {
	TextWidthResolverResult resolve(@NonNull final InnerTextToken innerTextToken, @NonNull final PDFont font, @NonNull final PDFont fallbackFont, final long fontSize);
}
