...
public class ContentInserterDependency implements ValueDependency<PDObjectInsertionResult> {
	@NonNull
	private final String id;
	@NonNull
	private final PDDocument segmentDocument;
	@NonNull
	private final PDSegmentObject pdSegmentObject;
	private final int startIndex;
	private final int endIndex;
	@NonNull
	Map<Integer, PDDocumentContainer> firstPageHeaderSection;
	@NonNull
	Map<Integer, PDDocumentContainer> firstPageFooterSection;
	@NonNull
	Map<Integer, PDDocumentContainer> remainingPageHeaderSection;
	@NonNull
	Map<Integer, PDDocumentContainer> remainingPageFooterSection;
}
