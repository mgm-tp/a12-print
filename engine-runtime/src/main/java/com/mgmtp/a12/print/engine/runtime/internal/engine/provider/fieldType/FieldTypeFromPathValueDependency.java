...
public class FieldTypeFromPathValueDependency implements ValueDependency<Optional<IFieldType>> {
	private final List<ComputationAlternative> computationAlternatives;
	private final ImmutableList<PrintModelPath.PathElement> parents;
}
