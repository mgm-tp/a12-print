...
public class ModelSegmentPrintResultDependency implements ValueDependency<ModelSegmentPrintResult> {
	private final int index;
	private final PrintModelTreeTrace<? extends TopLevelReferenceContainer> modelSegment;
