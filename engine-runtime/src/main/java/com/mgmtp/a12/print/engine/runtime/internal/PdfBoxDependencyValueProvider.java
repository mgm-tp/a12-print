...
@FunctionalInterface
public interface PdfBoxDependencyValueProvider<Value, Dependency extends ValueDependency<Value>> extends GenericDependencyValueProvider<Value, Dependency, PrintJob, PrintEngine<?>, InternalPdfBoxPrintEngineRuntime> {
