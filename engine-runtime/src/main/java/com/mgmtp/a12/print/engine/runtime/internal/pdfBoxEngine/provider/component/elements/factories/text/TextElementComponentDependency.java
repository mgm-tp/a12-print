...
public class TextElementComponentDependency implements ValueDependency<Component> {
	@NonNull
	PrintModelTreeTrace<TextElement> printModelElementTrace;
	List<TextValueMarkup> textValueMarkups;
