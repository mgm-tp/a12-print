...
@Builder
public class PreCompiledListingMap implements CoreDependencyFunction<PreCompiledListing, PreCompiledListingDependency> {

	@NonNull
	private final Map<String, PreCompiledListing> preCompiledListing;
