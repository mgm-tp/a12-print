...
public class TextBasedElementDependency implements ValueDependency<IPrintElement> {
	private final PrintModelTreeTrace<? extends PrintModelElement> printModelElementTrace;
	private final ValueFactory<Optional<String>> evaluatedValue;
	private final List<IPrintElement> childElements;
	private final boolean isHtml;

	public TextBasedElementDependency(
		final PrintModelTreeTrace<? extends PrintModelElement> printModelElementTrace,
		final ValueFactory<Optional<String>> evaluatedValue,
