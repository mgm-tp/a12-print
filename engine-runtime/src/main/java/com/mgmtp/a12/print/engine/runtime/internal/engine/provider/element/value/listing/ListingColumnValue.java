...
public interface ListingColumnValue {
	ListingColumn getColumn();

	Map<ColumnPropertyComputation.PropertyType, Object> getColumnProperties();

	Optional<String> getValue();

	boolean contentIsHTML();

	Optional<AttachmentSource> attachmentSource();
}
