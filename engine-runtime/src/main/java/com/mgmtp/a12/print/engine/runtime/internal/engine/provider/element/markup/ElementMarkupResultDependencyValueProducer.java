...
public class ElementMarkupResultDependencyValueProducer implements PdfDependencyValueProvider<MarkupResult, ElementMarkupResultDependency> {

	@Override
	public ValueFactory<MarkupResult> produce(ElementMarkupResultDependency dependency, PrintJob job, PrintEngine<?> engine, InternalPdfPrintEngineRuntime runtime) {
