...
import com.mgmtp.a12.print.engine.runtime.internal.manager.compiler.provider.ComputationExpressionEvaluation;
...
@Data
public class NullCheckExpression implements TypedComputationExpression {

	@NonNull
	private final String providerId;
	@NonNull
	private final String targetProviderId;
	private final boolean checkIfValueIsNull;

	@EqualsAndHashCode.Exclude
	private final Function<Optional<Object>, Boolean> valueCheck;

	public NullCheckExpression(
		@NonNull String providerId,
		@NonNull String targetProviderId,
		boolean checkIfValueIsNull
	) {
		this.providerId = providerId;
		this.targetProviderId = targetProviderId;
		this.checkIfValueIsNull = checkIfValueIsNull;
		this.valueCheck = checkIfValueIsNull ? Optional::isEmpty : Optional::isPresent;
	}
	...
	public Optional<Object> call(@NonNull Parameters parameters, @NonNull PrintJob job, @NonNull InternalCorePrintEngineRuntime internalCorePrintEngineRuntime) {
		return Optional.ofNullable(
			internalCorePrintEngineRuntime
				.provide(
					ComputationExpressionDependency
						.builder()
						.expressionId(targetProviderId)
						.parameters(parameters)
						.build()
				)
				.map(ComputationExpressionEvaluation::getObject)
				.map(valueCheck)
				.get()
		);
	}
