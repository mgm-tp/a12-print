...
public class ListingComponentDependency implements ValueDependency<Component> {
	@NonNull
	PrintModelTreeTrace<Listing> listingTreeTrace;
	@NonNull
	ListingValueResult listingValueResult;
	@NonNull
