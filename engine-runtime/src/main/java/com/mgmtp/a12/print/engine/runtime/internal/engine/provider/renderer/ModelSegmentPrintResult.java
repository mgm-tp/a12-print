...
@Data
@AllArgsConstructor
public class ModelSegmentPrintResult {
	private final int index;
	private final String segmentId;
	private final PDDocument pdDocument;
	private final PDSegmentObject pdSegmentObject;
	private final PrintModelTreeTrace<? extends TopLevelReferenceContainer> topLevelReferenceContainer;
	private final Map<String, AttachmentToAppend> attachmentsToAppend;
}
