...
@Data
public class Repetition implements IEntityInstance {

	@NonNull
	private final String path;
	private final int[] repetitions;

	public Repetition(@NonNull String path, int[] repetitions) {
		this.path = path;
		this.repetitions = repetitions;
	}

	public PrintDocumentIndex find(
		List<IEntityInstance> entityInstances
	) {
		return PrintDocumentIndex.from(Collections.binarySearch(
			entityInstances,
			this,
