...
public class BoundingBoxElementHtmlTemplateParameters implements HtmlTemplateParameters {
	@NonNull
	private final BoundingBox element;

	@NonNull
	private final ElementReference elementReference;

	@NonNull
	private final Collection<MarkupResult> markups;

	private final boolean cutoffElements;

	public PlaceableReference getPlaceableReference() {
		return elementReference instanceof PlaceableReference
			? (PlaceableReference) elementReference
			: null;
	}
}
