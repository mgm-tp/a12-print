...
@FunctionalInterface
public interface PdfDependencyValueProvider<Value, Dependency extends ValueDependency<Value>> extends GenericDependencyValueProvider<Value, Dependency, PrintJob, PrintEngine<?>, InternalPdfPrintEngineRuntime> {
