...
@FunctionalInterface
public interface ModelDocumentDependencyValueProvider<Value, Dependency extends ValueDependency<Value>> extends GenericDependencyValueProvider<Value, Dependency, PrintJob, PrintEngine<?>, InternalModelDocumentPrintEngineRuntime> {
