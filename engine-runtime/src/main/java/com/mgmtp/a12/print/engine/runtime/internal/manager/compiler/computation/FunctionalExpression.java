...
public class FunctionalExpression implements TypedComputationExpression {

	@NonNull
	private final String providerId;
	@NonNull
	private final ComputationExpression expression;
	@NonNull
	...
	public Optional<Object> call(@NonNull Parameters parameters, @NonNull PrintJob job, @NonNull InternalCorePrintEngineRuntime internalCorePrintEngineRuntime) {
		return expression.call(parameters, job, internalCorePrintEngineRuntime);
	}
