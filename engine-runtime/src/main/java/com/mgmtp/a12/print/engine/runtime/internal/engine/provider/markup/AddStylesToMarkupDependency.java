...
public class AddStylesToMarkupDependency implements ValueDependency<String> {
	private final String markup;
	private final Map<String, String> styles;
	private final boolean overwrite;

	public AddStylesToMarkupDependency(String markup, Map<String, String> styles, boolean overwrite) {
		this.markup = markup;
		this.styles = styles;
