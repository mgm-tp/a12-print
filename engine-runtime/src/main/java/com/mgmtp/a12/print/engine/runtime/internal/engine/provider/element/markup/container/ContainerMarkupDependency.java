...
@Data
@SuperBuilder
public abstract class ContainerMarkupDependency<T extends BaseReferenceContainer<?>> {
	@NonNull
	private final T element;

	@NonNull
	private final String spreadExpressionId;
	@NonNull
	private final ReferenceSpreadExpression referenceSpreadExpression;
	@NonNull
