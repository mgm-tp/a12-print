...
public class ListingValueDependency implements ValueDependency<ListingValueResult> {

	@NonNull
	private final PrintModelTreeTrace<Listing> listing;
	...
	public interface TextStyleProvider {
		TextStyle provideTextStyle(
			@NonNull final TextStyleDependency textStyleDependency
		);
	}
