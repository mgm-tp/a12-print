...
public class ModelDocumentWatermarkDependency implements ValueDependency<AttachmentWrapper<ModelDocumentWatermarkResult>>, ContainerProviderDependency {
	private final PrintModelTreeTrace<Watermark> watermark;
