...
@Data
public
class ComputedDocument implements IDocument {

	@NonNull
	private final String evaluationDocumentModelId;

	@NonNull
	private final Set<IEntityInstance> entityInstances;
	...
	public void setId(String id) {
		// Not needed for computed documents
	}

	@Override
	public String getDocumentModelId() {
		return evaluationDocumentModelId;
	}

	@Override
	public @NonNull Set<IEntityInstance> getEntityInstances() {
