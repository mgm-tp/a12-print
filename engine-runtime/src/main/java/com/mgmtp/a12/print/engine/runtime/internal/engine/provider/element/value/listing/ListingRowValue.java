...
public interface ListingRowValue {

	Map<RowPropertyComputation.PropertyType, Object> getRowProperties();

	Map<ImmutablePair<GroupPropertyComputation.PropertyType, String>, Object> getGroupProperties();
