...
public class AddWatermarkResult {
	private final @NonNull PDDocument resultDocument;
	private final @NonNull Map<PageOrientation, Optional<WatermarkResult>> watermarkResults;

	@AllArgsConstructor
	@Getter
	public static class WatermarkResult {
		private final @NonNull PDDocument document;
		private final @NonNull ModelSegmentPrintResult printResult;
	}
}
