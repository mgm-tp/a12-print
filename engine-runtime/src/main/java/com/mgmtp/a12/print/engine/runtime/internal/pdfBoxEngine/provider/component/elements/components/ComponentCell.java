...
public class ComponentCell {
	Component component;
	BoxStyleParameters boxStyle;
	@NonNull
	TextRenderStyle textRenderStyle;
	int colSpan;
	Long precalculatedYOffset;
	boolean ongoingRendering;

	public ComponentCell(Component component, BoxStyleParameters boxStyle, @NonNull TextRenderStyle textRenderStyle, int colSpan) {
		this.component = component;
		this.boxStyle = boxStyle;
		this.textRenderStyle = textRenderStyle;
		this.colSpan = colSpan;
		this.precalculatedYOffset = null;
